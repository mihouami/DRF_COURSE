...
from .views import ProductInfo, ProductList, ProductDetail, OrderList, UserOrderList # Importing view functions for the API.
...
urlpatterns = [
    ...
    path('product_info/', ProductInfo.as_view()),  # Endpoint to list all products.
